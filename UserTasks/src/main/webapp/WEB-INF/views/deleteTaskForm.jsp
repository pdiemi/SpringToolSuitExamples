...
<body>
        ...
        <div>
                ...
                <tr>
                    <td>
                        ...
                        <form:input path="taskName" readonly="true" required="true"/>
                ...
                <tr>
                    <td>
                        ...
                        <form:input path="taskStartDate" readonly="true" required="true" type="date"/>
                ...
                <tr>
                    <td>
                        ...
                        <form:input path="taskEndDate" readonly="true" required="true" type="date"/>
                ...
                <tr>
                    <td>
                        ...
                        <form:textarea path="taskDescription" readonly="true" rows="5" cols="30" required="true"/>
                ...
                <tr>
                    <td>
                        ...
                        <form:select path="taskSeverity" readonly="true" required="true" placeholder="choose severity">
    ...
    <br>
    <form action="../${taskEmail}/all-tasks" method="get">
