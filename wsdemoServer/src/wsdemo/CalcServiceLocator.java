...
public class CalcServiceLocator extends org.apache.axis.client.Service implements wsdemo.CalcService {
    ...
    private java.lang.String Calc_address = "http://localhost:8080/wsdemo/services/Calc";
    ...
    public wsdemo.Calc getCalc(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            wsdemo.CalcSoapBindingStub _stub = new wsdemo.CalcSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (wsdemo.Calc.class.isAssignableFrom(serviceEndpointInterface)) {
                wsdemo.CalcSoapBindingStub _stub = new wsdemo.CalcSoapBindingStub(new java.net.URL(Calc_address), this);
                _stub.setPortName(getCalcWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://wsdemo", "CalcService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://wsdemo", "Calc"));
        }
